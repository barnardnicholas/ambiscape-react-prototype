    ...
    renderPlusButton() {
        ...
        return (
          ...
          <div style={{...styles.tileContentStyling, padding: "0px"}}>
            <button style={{...styles.listButtonStyling, ...customButtonStyling}} onClick={this.handleToggleHighlight}>+</button>
          </div>
            </li>
        )
    }
    ...
    renderFullTile() {
        ...
        return (
          ...
          <div style={styles.tileContentStyling}>
            <label>Choose new channel:
            <select style={styles.selectStyling} onChange={this.handleChange} placeholder="Choose a channel">
            ...
            <button style={styles.listButtonStyling} onClick={this.handleAddChannel}>Add</button>
          </div>
        </li>
        )
    }
